package org.netbeans.modules.yooj.options;
...
final class YeomanPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(yeomanPathTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    void store() {
        NbPreferences.forModule(YeomanOptionsPanelController.class).put("yoExecutableLocation", yeomanPathTextField.getText());
    }
